...
namespace BetterGenshinImpact.GameTask.AutoFightOfficial.Assets;
        ...
        foreach (var exp in experienceValues)
        {
            ...
            try
            {
                var ro = new RecognitionObject
                {
                    ...
                    TemplateImageMat = GameTaskManager.LoadAssetImage("AutoFightOfficial", fileName, _captureWidth, _captureHeight),

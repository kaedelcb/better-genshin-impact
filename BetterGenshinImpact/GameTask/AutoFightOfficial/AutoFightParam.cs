...
public class AutoFightParam : BaseTaskParam<AutoFightTask>
{
    ...
    public AutoFightParam(string path, AutoFightOfficialConfig autoFightConfig) : base(null, null)
    {
        ...
        //下面参数固定，只取自动战斗里面的
        FinishDetectConfig.BattleEndProgressBarColor = TaskContext.Instance().Config.AutoFightOfficialConfig.FinishDetectConfig.BattleEndProgressBarColor;
        FinishDetectConfig.BattleEndProgressBarColorTolerance = TaskContext.Instance().Config.AutoFightOfficialConfig.FinishDetectConfig.BattleEndProgressBarColorTolerance;
    ...
    public void SetCombatStrategyPath(string? strategyName = null)
    {
        ...
        {
            strategyName = TaskContext.Instance().Config.AutoFightOfficialConfig.StrategyName;
        }

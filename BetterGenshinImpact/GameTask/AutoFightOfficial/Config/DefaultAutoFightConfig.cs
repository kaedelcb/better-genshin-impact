...
namespace BetterGenshinImpact.GameTask.AutoFightOfficial.Config;
...
public class DefaultAutoFightConfig
{
    ...
    {
        var json = File.ReadAllText(Global.Absolute(@"GameTask\AutoFightOfficial\Assets\combat_avatar.json"));

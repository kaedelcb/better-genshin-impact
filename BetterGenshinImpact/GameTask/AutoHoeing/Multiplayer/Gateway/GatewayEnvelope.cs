...
/// <summary>
/// 网关传输信封（BGI 客户端镜像，《通信方案》§4.2）——/gateway 上所有消息共用的 DTO。
...
public sealed record GatewayEnvelope
{
    ...
    /// <summary>消息名，如 "sync.reportArrival"、"room.create"。</summary>
    ...
    /// <summary>整个 payload 即业务对象时使用（如 room.versionCheckRejected 直传 VersionCheckResult）。</summary>

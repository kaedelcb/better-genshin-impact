...
public class AutoFightTask : ISoloTask
{
    ...
    public async Task Start(CancellationToken ct)
    {
        ...
        var fightTask = Task.Run(async () =>
        {
            ...
            //     // var skillSucceeded = await AutoFightSkill.AvatarSkillAsync(Logger, combatScenes?.SelectAvatar("玛薇卡"), false, 1, cts2.Token);
            //     // Logger.LogError("[AutoFight] ：{Elapsed}", skillSucceeded);
            //     // await Task.Delay(200, cts2.Token);
            // }

...
public sealed class TeleportCdCompensation
{
    ...
    /// 构造补偿器。
    /// </summary>
    /// <param name="isSoloWorld">是否处于单人世界的判定；缺省时读取 PathExecutor.CurrentMultiplayerCoordinator == null。</param>
    public TeleportCdCompensation(Func<bool>? isSoloWorld = null)
    {
        _isSoloWorld = isSoloWorld ?? (() => PathExecutor.CurrentMultiplayerCoordinator == null);
    }

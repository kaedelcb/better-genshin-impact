...
public class ControlStatus
{
    ...
    /// <summary>一条龙配置名 → 该配置内任务名列表（用于 WEB 端"从此处开始执行"选择起点）。</summary>
    ...
    /// <summary>好感任务进度文本（执行端 BGI FriendshipProgress 合成，好感任务不在跑为 null）。纯增量字段，旧客户端忽略。</summary>
    ...
    /// <summary>一键快捷命令绑定：命令名 → 配置组名/一条龙名（如 "一键传奇" → "GROUP:联机-传奇-锄地"）。</summary>
